...
Нужен работающий [провайдер вычислений](../providers/index.md) и обычно выбранный
gateway ([Установка](./install.md)).
...
См. [Credential-провайдеры](../guides/credentials.md) и [Cursor Agent](../guides/cursor.md).
...
- [Docker](../providers/docker/index.md) — ресурсы, логи, гигиена Desktop
- [Podman](../providers/podman/index.md) — rootless / Machine
- [Пересоздание sandbox](../guides/recreate-sandbox.md) — после смены policy
- [Политика](../guides/policy.md) — deny и rule approve
